...
function buildPrBody(corrections: Correction[]): string {
  ...
  const lines: string[] = [
    "## Spelling fixes",
    "",
    "This PR fixes spelling mistakes found in the project's documentation and text files. This was generated by [a real human](https://dawsbot.com) with assistance from this custom code [spelling-bee](https://github.com/dawsbot/spelling-bee).",
    "",
